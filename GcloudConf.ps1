...
$backupPaths       = @('', '') # You need not to use full path with drive letter, since drive letter is already specified in the variable above. Must not end with backslashes.
